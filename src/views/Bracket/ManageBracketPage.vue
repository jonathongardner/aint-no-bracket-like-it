    ...
    <edit-bracket v-if='initialGames' :value='winnerOfGames' :intialGames='initialGames'
      ...
      <div class='edit-bracket-inputs'>
        ...
        <div class="field has-addons">
          <div class="control has-icon has-icons-left has-icon-right">
            <input class="input is-large" type="text" placeholder="Bracket Name" v-model='name'>
            <span v-if='isUnique' class='icon is-large is-left'>
              <is-unique />
            </span>
            <span v-if='isUnique || this.gameAvailability.unique' class="icon is-small is-right">
